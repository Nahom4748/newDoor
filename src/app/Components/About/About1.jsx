  ...
  return (
          ...
          <div className="col-xl-6">
            <div className="cs_about_thumbnail_wrapper position-relative">
              <div className="cs_about_thumbnail">
                <Image src={img1} alt="img" width={343} height={268} />
              </div>
              <div className="cs_about_thumbnail">
                <Image src={img2} alt="img" width={343} height={262} />
              </div>
              <div className="cs_about_thumbnail">
   ...
   <Image
              ...
              <a className="cs_phone_call cs_heading_color">
                ...
                <a href="tel:+251908676767" className="cs_phone_number cs_fs_24 cs_semibold">
  +251908 676767
</a>
          ...
          <div className="col-xl-6">
            <div className="cs_about_text">
              <div className="cs_section_heading cs_style_1 cs_mb_20">
                ...
                <h2 className="cs_section_title cs_fs_50 mb-0 wow fadeInUp">
                  {Title}
                </h2>
              </div>
